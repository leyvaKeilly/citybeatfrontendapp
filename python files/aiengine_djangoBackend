...
# settings = {'modelType' : modelType['multilogreg'], #select dictionary value of the modelType you want to run
#             'checkF1Scores':True, #show f1 score for single specified user
#             'numKFolds': 5, #must be an integer set to greater than 2. default setting is 5
#             'showVidTitles':True, #shows video titles for model output on singular user
#             'nUserF1Scores':True, #outputs average of model's F1 scores over the specified fraction of randomly selected users
#             'nUserFraction':.66 #value between 0 and 1. sets fraction of total number of users to check F1 score on
#            }
#
